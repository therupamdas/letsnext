...
const About = () => {
  return (
    ...
    <h1>About Vring:<br></br>Your Creative Hub for Video Editing, Photo Editing, and Design</h1>
      ...
      <p>Whether youre a seasoned professional or just starting your creative journey, Vring provides intuitive tools and expert guidance to bring your vision to life. Our robust video editing suite empowers you to craft dynamic videos that tell compelling stories, with precision and flair. From basic edits to advanced effects, Vring ensures every frame is polished to perfection.</p>

      <p>For photographers, Vring offers powerful photo editing capabilities that enhance every pixel, elevating your photos to new heights. Whether its retouching portraits, enhancing landscapes, or creating stunning compositions, our tools are designed to meet your artistic demands with ease.
      </p>
